...
const barLineData = [
  { name: "Nov", Conductores: 20, Pasajeros: 18, Activos: 22 },
  { name: "Dic", Conductores: 28, Pasajeros: 25, Activos: 35 },
  { name: "Ene", Conductores: 38, Pasajeros: 35, Activos: 50 },
  { name: "Feb", Conductores: 35, Pasajeros: 32, Activos: 48 },
];

const lineChartData = [
  { month: "Ene", Conductores: 10, Pasajeros: 15, Activos: 12 },
  { month: "Feb", Conductores: 15, Pasajeros: 18, Activos: 20 },
  { month: "Mar", Conductores: 25, Pasajeros: 20, Activos: 28 },
  { month: "Abr", Conductores: 22, Pasajeros: 28, Activos: 35 },
  { month: "May", Conductores: 35, Pasajeros: 32, Activos: 45 },
];
...
export default function AdminStatistics() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-blue-50">
      <header className="flex items-center justify-between px-6 py-4 bg-white/90 backdrop-blur-sm border-b border-gray-200">
      ...
      <main className="p-6 max-w-7xl mx-auto">
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="w-full">
                ...
                <BarChart width={280} height={220} data={barLineData} margin={{ top: 8, right: 4, left: -20, bottom: 20 }}>
                  <defs>
                  ...
                  <Bar dataKey="Conductores" stackId="a" fill="url(#gConductores)" radius={[0, 0, 0, 0]} barSize={20} />
                  <Bar dataKey="Pasajeros" stackId="a" fill="url(#gPasajeros)" radius={[0, 0, 0, 0]} barSize={20} />
                  <Bar dataKey="Activos" stackId="a" fill="url(#gActivos)" radius={[4, 4, 0, 0]} barSize={20} />
                  <Legend verticalAlign="bottom" align="center" iconType="circle" wrapperStyle={{ paddingTop: 4, fontSize: 9 }} />
                </BarChart>
              </div>
              ...
              <div className="w-full">
                ...
                <LineChart width={280} height={220} data={lineChartData} margin={{ top: 8, right: 4, left: -20, bottom: 20 }}>
                  <CartesianGrid stroke="#E6EEF9" strokeDasharray="3 3" vertical={false} />
                  <XAxis dataKey="month" axisLine={false} tickLine={false} tick={{ fill: "#475569", fontSize: 9 }} />
                  <YAxis axisLine={false} tickLine={false} tick={{ fill: "#475569", fontSize: 10 }} width={30} />
                  <Tooltip wrapperStyle={{ borderRadius: 8, boxShadow: "0 6px 18px rgba(16,24,40,0.08)" }} />
                  <Line type="monotone" dataKey="Conductores" stroke="#22d3ee" strokeWidth={2.5} dot={{ fill: "#22d3ee", r: 4 }} />
                  <Line type="monotone" dataKey="Pasajeros" stroke="#ec4899" strokeWidth={2.5} dot={{ fill: "#ec4899", r: 4 }} />
                  <Line type="monotone" dataKey="Activos" stroke="#06b6d4" strokeWidth={2.5} dot={{ fill: "#06b6d4", r: 4 }} />
                  <Legend verticalAlign="bottom" align="center" iconType="circle" wrapperStyle={{ paddingTop: 4, fontSize: 9 }} />
                </LineChart>
              </div>
            </div>
          ...
          <div className="bg-white rounded-2xl p-5 border border-gray-100 shadow-sm">
            ...
            <AreaChart width={580} height={280} data={areaData} margin={{ top: 8, right: 8, left: 0, bottom: 30 }}>
              <defs>
